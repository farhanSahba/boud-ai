...
function frontendSettingsSave() {
	...
	document.getElementById("settings_button").innerHTML = bued_localize.please_wait;
	...
	$.ajax({
		...
		success: function (data) {
			toastr.success(bued_localize?.settings_saved ||'Settings saved succesfully')
...
function generalSettingsSave() {
    ...
    $.ajax({
        ...
        processData: false,
        success: function (data) {
            toastr.success(bued_localize?.settings_saved_redirecting ||'Settings saved succesfully. Redirecting...')
            document.getElementById("settings_button").disabled = false;
            document.getElementById("settings_button").innerHTML = "Save";
            setTimeout(function () {
...
function introductionSettingsSave() {
    ...
    $.ajax({
        ...
        processData: false,
        success: function (data) {
            toastr.success(bued_localize?.settings_saved || 'Introductions saved successfully');
            document.getElementById("settings_button").disabled = false;
            document.getElementById("settings_button").innerHTML = "Save";
        },
        error: function (data) {
...
function faqCreateOrUpdate(faq_id) {
    ...
    document.getElementById("faq_button").innerHTML = bued_localize.please_wait;
    ...
    $.ajax({
        ...
        processData: false,
        success: function () {
            toastr.success(bued_localize?.faq_saved ||'Faq saved succesfully. Redirecting')
            setTimeout(function () {
...
function toolsCreateOrUpdate(item_id) {
    ...
    document.getElementById("item_button").innerHTML = bued_localize.please_wait;
    ...
    $.ajax({
        ...
        processData: false,
        success: function () {
            toastr.success(bued_localize?.item_saved ||'Item saved succesfully. Redirecting')
            setTimeout(function () {
