...
function categorySave( item_id ) {
    ...
    $.ajax( {
        type: "post",
        url: "/dashboard/admin/openai/chat/category/save",
        data: formData,
        contentType: false,
        processData: false,
        success: function ( data ) {
            toastr.success(bued_localize?.template_saved ||'Template Saved Succesfully')
            location.href = '/dashboard/admin/openai/chat/category';
