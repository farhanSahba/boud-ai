...
>
    <div class="mb-5 flex justify-between max-lg:flex-col max-lg:gap-4 lg:items-center">
        <h3 class="mb-0 flex flex-wrap items-center gap-2">
            {{ __('Explain your idea') }}. |
            <button
                class="lqd-image-generator-random-prompt-trigger cursor-pointer text-secondary hover:underline"
                type="button"
                x-data="{}"
        ...
        <div class="lqd-image-generator-tabs-nav flex grow flex-wrap gap-0.5 max-lg:-order-1 lg:justify-end">
    ...
    @if (setting('dalle_hidden', 0) !== 1)
        ...
        >
            ...
            >
                ...
                <x-button
                    class="lqd-generator-advanced-trigger group mt-1 flex w-full items-center gap-8 text-2xs font-medium text-heading-foreground"
                ...
                >
                    ...
                    <span class="flex items-center gap-2">
                        ...
                        <x-tabler-chevron-up
                            ...
                            ::class="{ 'rotate-180': advancedSettingsShow }"
                        />
                    </span>
                    <span class="inline-block h-px grow bg-border"></span>
                </x-button>
...
@if (count($ai_tools) > 0)
    <div
        class="lqd-img-gen-tools-wrap mb-10 space-y-8 rounded-card bg-foreground/5 py-7"
        x-data="{ toolsShow: false }"
    >
        ...
        <div
            class="lqd-img-gen-tools hidden grid-cols-1 gap-6 px-5 md:grid-cols-2 lg:grid-cols-3"
