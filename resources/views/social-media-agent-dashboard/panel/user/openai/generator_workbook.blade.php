    ...
    <div class="py-10">
        ...
        >
            <div class="flex w-full flex-col gap-6">
                ...
                >
                    <div
                        class="group relative mb-8 w-full grow"
                    ...
                    >
                        <button
                            class="relative z-20 flex w-full items-center justify-between rounded-full bg-card-background px-5 py-4 text-xs font-medium shadow-[0_8px_33px_hsl(0_0%_0%/5%)] dark:bg-input-background"
                            type="button"
