...
>
    ...
    <div class="relative z-1 mx-auto lg:w-7/12">
        <p class="mb-8 text-center text-[21px] font-semibold leading-none -tracking-wider">
        ...
        @php
            ...
            if (\App\Helpers\Classes\MarketplaceHelper::isRegistered('marketing-bot')) {
                if (\Illuminate\Support\Facades\Route::has('dashboard.user.marketing-bot.whatsapp-campaign.index')) {
                    $socials[] = [
                        'label' => __('WhatsApp'),
                        'icon' =>
                ...
                if (\Illuminate\Support\Facades\Route::has('dashboard.user.marketing-bot.telegram-campaign.index')) {
                    $socials[] = [
                        'label' => __('Telegram'),
                        'icon' =>
