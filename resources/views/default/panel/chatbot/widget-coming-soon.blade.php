...
<div id="bued-ai-chatbot-widget" class="{{ $settings_two->chatbot_position ?: 'bottom-left' }}">
    <div class="bued-ai-chatbot-widget--chat active-message-list bg-white active">
        <div class="bued-ai-chatbot-widget--header border-b-amber-700">
            <div class="title">Bued Bot<br><span>Theme Support</span>
            </div>
        ...
        <div class="bued-ai-chatbot-widget--message-list">
            @foreach($userChats as $userChat)
                <div class="bued-ai-chatbot-widget--message-list--item" data-id="{{ $userChat->id }}">
                    <img src="{{ $chatbot->image ? '/uploads/'.$chatbot->image : '/assets/img/chat-default.jpg' }}" class="svg" alt="ChatBot">
                    <div class="bued-ai-chatbot-widget--message-list--item-title">
        ...
        <button type="button" class="btn bued-ai-btn start-new-chat">Start New Chat</button>
        <div class="bued-ai-chatbot-widget--messages"></div>
        <form action="">
    ...
    <div class="bued-ai-chatbot-widget--trigger loaded bg-white">
        <img src="{{ $chatbot->image ? '/uploads/'.$chatbot->image : '/assets/img/chat-default.jpg' }}" class="svg" alt="ChatBot">
    </div>
</div>
