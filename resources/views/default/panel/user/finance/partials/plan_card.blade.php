...
<div @class([
    ...
    <div class="flex h-full flex-col p-7">
        ...
        <ul class="list-unstyled mt-5 w-full rounded-lg border p-4">
            ...
            @if (($newDiscountedPrice > 0) && (($plan->price - $newDiscountedPrice) > 0))
                <hr class="mt-0">
                <li class="flex px-1">
            ...
            <li class="flex px-1">
                ...
                <p class="whitespace-nowrap text-end">{!! displayCurr(currency()->symbol, $plan->price, $taxValue ?? 0, ($newDiscountedPrice > 0 ? $newDiscountedPrice : null), tax_included: $plan->price_tax_included) !!}</p>
            </li>
        </ul>
