<script>
	function generateSpeech() {
		...
		document.getElementById("generate_speech_button").innerHTML = bued_localize.please_wait;
	...
	const voicesData = {
		...
		"gu-IN": [{
			...
			label: "àھ¦àھ؟àھµà«چàھ¯àھ¾ ({{ __('Female') }})"
		},
			{
				value: "gu-IN-Standard-B",
				label: "àھ•àھ؟àھ¶à«‹àھ° ({{ __('Male') }})"
			},
			{
