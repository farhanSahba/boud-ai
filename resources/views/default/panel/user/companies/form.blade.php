...
@section('settings')
    ...
    >
        ...
        <x-forms.input
            id="c_website"
            label="{{ __('Website') }}"
            tooltip="{{ __('Please provide the full web address (URL) of your companyâ€™s official website.') }}"
            name="c_website"
            size="lg"
            placeholder="{{ __('Enter the URL of your companyâ€™s website.') }}"
            value="{{ $item?->website }}"
        />
        ...
        <x-forms.input
            id="c_tagline"
            label="{{ __('Tagline') }}"
            tooltip="{{ __('A memorable and succinct phrase encapsulating your companyâ€™s mission or value proposition.') }}"
            size="lg"
            name="c_tagline"
...
@push('script')
    <script>
        ...
        $('#custom_company_button').click(function() {
            ...
            document.getElementById("custom_company_button").innerHTML = bued_localize.please_wait;
