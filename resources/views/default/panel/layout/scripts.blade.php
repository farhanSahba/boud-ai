...
<script>
	...
	var bued_localize_second_part = {
		...
		please_activate_bued_ai: @json(__('Please activate Bued AI')),
		please_active_magicai: @json(__('Please activate Bued AI')),
	...
	Object.assign(bued_localize, bued_localize_second_part);
	window.bued_localize = bued_localize;
	window.magicai_localize = bued_localize;
</script>
