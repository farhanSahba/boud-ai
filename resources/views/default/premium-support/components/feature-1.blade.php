		...
		<div class="w-full mb-20">
			<div class="mx-auto mb-16 w-full text-center lg:w-1/2">
				<h2 class="mb-5 text-[52px] leading-[0.94em]">
					@lang('Get the Bued mobile app for free.')
				</h2>
				<p class="text-[19px] leading-[1.42em]">
					@lang("Exclusively for Premium users: Get the Bued mobile app (iOS and Android) completely free in your fourth month—valued at $3,000, with no extra cost.")
				</p>
			</div>
