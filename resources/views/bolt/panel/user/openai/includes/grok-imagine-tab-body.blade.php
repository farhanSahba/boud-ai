<div
    ...
    :class="{ 'hidden': activeGenerator !== 'xai/grok-imagine-image' }"
>

    <form
        class="lqd-image-generator-flux-pro-form flex flex-col items-start gap-4"
        id="openai_generator_form"
        onsubmit="return sendGrokImagineGeneratorForm();"
    ...
    >
        ...
        <div class="lqd-image-generator-inputs-wrap relative w-full">
            ...
            <x-button
                ...
                id="grok_imagine_generator_button"
                tag="button"
                type="submit"
            >
                {{ __('Generate') }}
