    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('advancedImageEditorForm', () => ({
                ...
                supportImageModels: ['stable_diffusion', 'gpt-image-1', 'flux-pro-kontext', 'nano-banana', 'nano-banana-pro', 'nano-banana-2', 'xai/grok-imagine-image'],
                ...
                onFormSubmit() {
                    ...
                    const supportImageModels = ['stable_diffusion', 'gpt-image-1', 'flux-pro-kontext', 'nano-banana', 'nano-banana-pro', 'nano-banana-2', 'xai/grok-imagine-image'];
