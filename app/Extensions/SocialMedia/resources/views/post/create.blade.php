                        ...
                        >
                            ...
                            <div x-show="!['tiktok', 'youtube', 'youtube-shorts'].includes(currentPlatform)">
                                <div class="mb-2 flex items-center justify-between">
                                    <label class="flex items-center gap-1.5 text-2xs font-medium text-heading-foreground">
                                        @lang('Select Image(s)')
                            ...
                            <div class="space-y-4">
                                ...
                                >
                                    <x-slot:trigger
                                        class="w-full text-2xs font-semibold disabled:pointer-events-none disabled:opacity-50"
                                        variant="outline"
                                        type="button"
                                        size="lg"
                                        ::disabled="isPosting"
                ...
                Alpine.data('socialMediaPostCreate', () => ({
                    ...
                    async generateImage() {
                        ...
                        for (let i = 0; i < imageCount; i++) {
                            try {
                                console.log(`[Image ${i + 1}/${imageCount}] Starting generation...`);
                                ...
                                const data = await response.json();
                                console.log(`[Image ${i + 1}/${imageCount}] Response:`, data);
