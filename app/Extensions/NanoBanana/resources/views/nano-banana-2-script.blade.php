<script>
    function sendNanoBanana2GeneratorForm(ev) {
        ev?.preventDefault();
        ev?.stopPropagation();

        const submitBtn = document.getElementById("nano_banana_2_generator_button");

        document.getElementById("nano_banana_2_generator_button").disabled = true;
        document.getElementById("nano_banana_2_generator_button").innerHTML = bued_localize.please_wait;
        ...
        formData.append('description', $("#description_nano_banana_2").val());
        formData.append('model', 'nano-banana-2');
        formData.append('image_number_of_images', 1);
        formData.append('image_generator', 'nano-banana-2');
        ...
        formData.append('description_nano_banana_2', $('#description_nano_banana_2').val());
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.status !== 'success' && (res.message)) {
					document.getElementById("nano_banana_2_generator_button").disabled = false;
					document.getElementById("nano_banana_2_generator_button").innerHTML = "Regenerate";
