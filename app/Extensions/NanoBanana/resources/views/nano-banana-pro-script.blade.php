<script>
    function sendNanoBananaProGeneratorForm(ev) {
        ev?.preventDefault();
        ev?.stopPropagation();

        const submitBtn = document.getElementById("nano_banana_pro_generator_button");

        document.getElementById("nano_banana_pro_generator_button").disabled = true;
        document.getElementById("nano_banana_pro_generator_button").innerHTML = bued_localize.please_wait;
        ...
        formData.append('description', $("#description_nano_banana_pro").val());
        formData.append('model', 'nano-banana-pro');
        formData.append('image_number_of_images', 1);
        formData.append('image_generator', 'nano-banana-pro');
        ...
        formData.append('description_nano_banana_pro', $('#description_nano_banana_pro').val());
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.status !== 'success' && (res.message)) {
					document.getElementById("nano_banana_pro_generator_button").disabled = false;
					document.getElementById("nano_banana_pro_generator_button").innerHTML = "Regenerate";
