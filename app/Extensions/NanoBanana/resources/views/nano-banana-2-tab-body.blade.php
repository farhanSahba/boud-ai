<div
    ...
    :class="{ 'hidden': activeGenerator !== 'nano-banana-2' }"
>

    <form
        class="lqd-image-generator-flux-pro-form flex flex-col items-start gap-4"
        id="openai_generator_form_nano_banana_2"
        onsubmit="return sendNanoBanana2GeneratorForm();"
    ...
    >
        ...
        <div class="lqd-image-generator-inputs-wrap relative w-full">
            ...
            <x-button
                ...
                id="nano_banana_2_generator_button"
                tag="button"
                type="submit"
            >
                {{ __('Generate') }}
