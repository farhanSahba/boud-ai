...
namespace App\Extensions\MultiModel\System;

use App\Domains\Marketplace\Contracts\ExtensionRegisterKeyProviderInterface;
use App\Domains\Marketplace\Contracts\UninstallExtensionServiceProviderInterface;
use App\Extensions\MultiModel\System\Http\Controllers\MultiModelController;
 ...
 */
class MultiModelServiceProvider extends ServiceProvider implements ExtensionRegisterKeyProviderInterface, UninstallExtensionServiceProviderInterface
{
    ...
    {
        //        $this->loadViewComponentsAs('multi-model', []);
    ...
    {
        $this->publishes([
            //            __DIR__ . '/../resources/assets/js' => public_path('vendor/multimodel/js'),
            //            __DIR__ . '/../resources/assets/images' => public_path('vendor/multimodel/images'),
        ], 'extension');
    ...
    {
        $this->mergeConfigFrom(__DIR__ . '/../config/multimodel.php', 'multi-model');
    ...
    {
        $this->loadTranslationsFrom(__DIR__ . '/../resources/lang', 'multi-model');
    ...
    {
        $this->loadViewsFrom([__DIR__ . '/../resources/views'], 'multi-model');
    ...
    private function registerRoutes(): static
    {
        $this->router()
            ->group([
                ...
                'controller' => MultiModelController::class,
