...
namespace App\Extensions\AIChatProFileChat\System;
 ...
 */
class AIChatProFileChatServiceProvider extends ServiceProvider implements ExtensionRegisterKeyProviderInterface, UninstallExtensionServiceProviderInterface
{
    ...
    {
        //        $this->loadViewComponentsAs('ai-chat-pro-file-chat', []);
    ...
    {
        $this->publishes([
            //            __DIR__ . '/../resources/assets/js' => public_path('vendor/ai-chat-pro-file-chat/js'),
            //            __DIR__ . '/../resources/assets/images' => public_path('vendor/ai-chat-pro-file-chat/images'),
        ], 'extension');
    ...
    {
        $this->mergeConfigFrom(__DIR__ . '/../config/aichatprofilechat.php', 'ai-chat-pro-file-chat');
    ...
    {
        $this->loadTranslationsFrom(__DIR__ . '/../resources/lang', 'ai-chat-pro-file-chat');
    ...
    {
        $this->loadViewsFrom([__DIR__ . '/../resources/views'], 'ai-chat-pro-file-chat');
