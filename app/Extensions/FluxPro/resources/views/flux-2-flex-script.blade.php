<script>
    function sendFluxTwoFlexGeneratorForm(ev) {
        ev?.preventDefault();
        ev?.stopPropagation();

        const submitBtn = document.getElementById("flux_two_flex_generator_button");

        document.getElementById("flux_two_flex_generator_button").disabled = true;
        document.getElementById("flux_two_flex_generator_button").innerHTML = bued_localize.please_wait;
        ...
        formData.append('description', $("#description_flux_two_flex").val());
        formData.append('model', '{{ \App\Domains\Entity\Enums\EntityEnum::FLUX_2_FLEX->value }}');
        ...
        formData.append('description_flux_pro', $('#description_flux_two_flex').val());
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.status !== 'success' && (res.message)) {
                    document.getElementById("flux_two_flex_generator_button").disabled = false;
                    document.getElementById("flux_two_flex_generator_button").innerHTML = "Regenerate";
