<script>
    function sendMidjourneyGeneratorForm(ev) {
        ...
        document.getElementById("midjourney_generator_button").innerHTML = bued_localize.please_wait;
        ...
        @if ($openai->type === 'image')
            let imageGenerator = document.querySelector('[data-generator-name][data-active=true]')?.getAttribute(
                'data-generator-name');
        @endif
