<nav
    class="lqd-adv-img-editor-nav fixed inset-x-0 top-0 z-10 flex h-[--header-h] gap-4 border-b border-heading-foreground/5 px-4 py-2.5 before:absolute before:inset-0 before:-z-1 before:bg-background/10 before:backdrop-blur-xl before:backdrop-saturate-[120%] md:gap-6 md:px-6">
    <div class="flex shrink-0 items-center gap-4 md:gap-6">
        <div
            ...
            :class="{ 'w-0 -me-6': currentView !== 'home', 'size-[36px]': currentView === 'home' }"
        >
            <x-button
    ...
    <div
        class="flex grow items-center gap-4 transition max-md:invisible max-md:absolute max-md:inset-x-0 max-md:top-full max-md:z-9 max-md:h-[--header-h] max-md:-translate-y-1 max-md:overflow-x-auto max-md:whitespace-nowrap max-md:border-b max-md:border-heading-foreground/5 max-md:bg-background/10 max-md:px-4 max-md:py-1 max-md:opacity-0 max-md:backdrop-blur-xl max-md:backdrop-saturate-[120%] md:gap-6"
        :class="{ 'max-md:opacity-0 max-md:invisible max-md:-translate-y-1': !mobileNavbarShow || !editingImage.output }"
    >
        <div
        ...
        >
            <span
                class="inline-block h-6 w-px bg-heading-foreground/[8%] max-md:hidden"
            ...
            <div
                ...
                x-transition
            >
                <span class="inline-block h-6 w-px bg-heading-foreground/[8%] max-md:hidden"></span>
        ...
        <div
            class="ms-auto flex select-none items-center justify-end gap-4 md:gap-6"
            :class="{ 'opacity-50 pointer-events-none': busy }"
        >
            <div
    ...
    <div class="ms-auto flex items-center gap-4">
        ...
        <x-button
            ...
            variant="link"
            size="none"
            @click.prevent="mobileNavbarShow = !mobileNavbarShow"
            x-cloak
            x-show="currentView === 'editor' && editingImage.output"
        >
            {{ __('More') }}
