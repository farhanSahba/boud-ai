    ...
    ->group(static function () {
        ...
        Route::prefix('admin')
            ...
            ->group(function () {
                ...
                // External updater disabled in local marketplace mode.
                Route::get('update', static fn () => abort(404))->name('update.index');
                ...
                // External license management disabled in local marketplace mode.
                Route::get('license', static fn () => abort(404))->name('license.index');
